...
**Last updated:** 2026-06-28 (scope down calendar RSVP — feed-dependent, Google secret-iCal omits it; reconcile RECURRENCE-ID overrides); 2026-06-25 (read-only Slack connector); 2026-06-24 (mailbox aliases + `list_mailboxes`; calendar RSVP status) · **Branch of record:** `main`
